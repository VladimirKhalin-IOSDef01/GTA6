...
final class ActualModesTabViewCellNew: UITableViewCell, ActualReusable {
    ...
    public override func prepareForReuse() {
        // ref default
        seasonsTranslateAsSpring(from: "Summer")
        // ref default
    ...
    private func actualSetImageMod(_ mode: ActualModItem) {
        // ref default
        seasonsTranslateAsSpring(from: "Winter")
        // ref default
    ...
    private func actualIsLocalCachePhoto(with path: String?) -> Bool {
        // ref default
        seasonsTranslateAsSpring(from: "Autumn")
        // ref default
    ...
    // def 04
    func seasonsTranslateAsSpring(from season: String) -> String? {
        let seasonNames = ["Spring", "Summer", "Autumn", "Winter"]
        guard let index = seasonNames.firstIndex(of: season) else { return nil }

...
final class PerspectiveGameCheatsTabViewCell: UICollectionViewCell {
    ...
    public func configure(with value: PerspectiveCheat_Item) {
    ...
    private func configureCodes(_ value: PerspectiveCheat_Item) -> [String] {
        var codes: [String] = []
